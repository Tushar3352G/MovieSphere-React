...
import { asyncmovieload } from "../Store/Action/movieActions";
import { Link, Outlet, useLocation, useParams } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import Loader from "../Components/Loader";
import { removeMovie } from "../Store/Reducers/movieReducer";
  ...
  return info ? (
    ...
    >
      ...
      <div className="w-full h-full px-8 mb-20">
        ...
        <div className="flex pt-8 px-8 gap-10">
          ...
          <div className="mt-5">
            ...
            <h2 className="text-xl mt-1 font-medium ">{info.detail.tagline}</h2>
            ...
            <div className="mt-5  w-full">
              ...
              <p className="w-[90%] text-wrap">
                {info.translations.map((item) => item.english_name).join(", ")}
              </p>
            </div>
            ...
            <div className="flex mt-8 justify-start items-start">
              ...
              <Link
                to={`${pathname}/trailer`}
                className={`${info.WatchProviders && 'mt-6'} bg-[var(--primarycolor)] font-semibold text-lg px-10 py-4 rounded-full inline-block text-nowrap`}
              >
                Watch Trailer
              </Link>
            </div>
      ...
      <div className="w-full pb-8">
        <h1 className="text-3xl px-16 font-bold mb-8">Blockbuster Recommendations</h1>
        <SwiperSliders
          height='h-[28vw]'
          show="4.3"
          Padding="px-16"
